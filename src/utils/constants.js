...
export const PORTFOLIO_PAGE_9 = {
  ...
  description: [
    'This project was developed as a part of the Mobile Cartography class at the Technical University of Dresden. It is a mobile game that combines location-based services, storytelling, and interactive elements to create a compelling detective experience. The game involves following a series of locations to gather evidence and ultimately solve the case. Through this project, I put my knowledge of mobile development, cartography and database management into practice by creating an engaging and interactive experience.',
    'The application was developed in Android Studio Code using Java. To create an interactive map that played a central role in this mobile application, I utilized the Google Maps SDK for Android. The geographical coordinates of the locations within the game were stored in an SQLite database.',
    'The user interface was designed in Figma, ensuring a visually appealing and intuitive design. To enhance the storytelling, the project incorporates images of the locations and suspects generated using Midjourney, adding a unique and visually engaging dimension to the game. This mobile game successfully combines the elements of cartography, detective work, and interactive storytelling.',
  ],
  technology: [
...
export const PORTFOLIO_PAGE_8 = {
  ...
  altImg: 'Crowded Space',
  description: [
    'This project was created for the module of Digital Map Creation in the summer semester of 2023 at the Technical University of Vienna as part of the Cartography M.Sc. The interactive 3D web-based visualization aims to increase awareness about the growing number of satellites and debris around the Earth.',
    'The application features a realistic 3D Earth model and displays the real-time positions of active satellites. The visualization incorporates historical context, highlighting significant milestones in space exploration and the evolution of satellite technology, providing a deeper understanding of the evolution of space industry. In addition, the visualization is complemented with statistics related to satellites including satellite ownership, satellite purpose and space debris.',
    "I was responsible for designing and developing the frontend of this project. The application's user interface was built using React and Three.js library was employed to create the realistic Earth model and visualize satellites as points. The application utilizes satellite data that provides accurate positions up to 2023 based on the database maintained by Celestrak. In addition, the Satellite.js library was used for calculating and updating satellite positions based on the available data.",
